      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-2">
            ...
            <Button variant="outline" onClick={() => setUploadDrawerOpen(true)} className="flex-1 sm:flex-none">
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 sm:w-16 sm:h-16 bg-muted rounded-lg flex items-center justify-center shrink-0">
                        {video.urls.thumb ? (
                          ...
                          <Play className="h-4 w-4 sm:h-6 sm:w-6 text-muted-foreground" />
                        )}
                      </div>
                    ...
                    <div className="text-left sm:text-right">
                      ...
                      {video.status !== 'ready' && video.status !== 'failed' && (
                        <Progress value={50} className="w-full sm:w-24 mt-1" />
                      )}
                    </div>
                  </div>
                ))}
